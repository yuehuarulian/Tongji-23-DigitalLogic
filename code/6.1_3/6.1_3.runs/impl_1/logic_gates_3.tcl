...
set rc [catch {
  ...
  set_property webtalk.parent_dir E:/szlj/vivado_save/6.1_3/6.1_3.cache/wt [current_project]
  set_property parent.project_path E:/szlj/vivado_save/6.1_3/6.1_3.xpr [current_project]
  set_property ip_repo_paths e:/szlj/vivado_save/6.1_3/6.1_3.cache/ip [current_project]
  set_property ip_output_repo e:/szlj/vivado_save/6.1_3/6.1_3.cache/ip [current_project]
  add_files -quiet E:/szlj/vivado_save/6.1_3/6.1_3.runs/synth_1/logic_gates_3.dcp
  read_xdc E:/szlj/vivado_save/6.1_3/6.1_3.srcs/constrs_1/new/logic_gates_3.xdc
