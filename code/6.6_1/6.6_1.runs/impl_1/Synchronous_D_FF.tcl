...
set rc [catch {
  ...
  set_property ip_repo_paths e:/szlj/vivado_save/6.6_1/6.6_1.cache/ip [current_project]
  set_property ip_output_repo e:/szlj/vivado_save/6.6_1/6.6_1.cache/ip [current_project]
  add_files -quiet E:/szlj/vivado_save/6.6_1/6.6_1.runs/synth_1/Synchronous_D_FF.dcp
