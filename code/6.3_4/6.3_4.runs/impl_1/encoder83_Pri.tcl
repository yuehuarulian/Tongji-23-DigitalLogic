...
set rc [catch {
  ...
  set_property webtalk.parent_dir E:/szlj/vivado_save/6.3_4/6.3_4.cache/wt [current_project]
  set_property parent.project_path E:/szlj/vivado_save/6.3_4/6.3_4.xpr [current_project]
  set_property ip_repo_paths e:/szlj/vivado_save/6.3_4/6.3_4.cache/ip [current_project]
  set_property ip_output_repo e:/szlj/vivado_save/6.3_4/6.3_4.cache/ip [current_project]
  add_files -quiet E:/szlj/vivado_save/6.3_4/6.3_4.runs/synth_1/encoder83_Pri.dcp
  read_xdc E:/szlj/vivado_save/6.3_4/6.3_4.srcs/constrs_1/new/encoder83.xdc
  link_design -top encoder83_Pri -part xc7a100tcsg324-1
